...
export const harvestNodes = [
    ...
    { id: 'tree-2', type: 'tree', label: 'Árbol', ...pos(430, 590), w: 48, h: 64, interactionRadius: 62, requiredTool: 'hacha', action: 'Talando', drop: 'Madera', uses: 0, maxUses: 5, recoveryUntil: 0 },
    ...
    { id: 'iron-ore-1', type: 'ironOre', label: 'Mena de hierro', ...pos(680, 700), w: 44, h: 40, interactionRadius: 58, requiredTool: 'pico', action: 'Minando', drop: 'Mineral de Hierro', uses: 0, maxUses: 5, recoveryUntil: 0 }
];
